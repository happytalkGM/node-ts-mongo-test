...
(async() => {
    console.log('start');
    console.log(`initial connection count: ${db.adapter.client.connectionPool.connections.length}`);
    ...
    console.log(`latest connection count: ${db.adapter.client.connectionPool.connections.length}`);
})().catch((e) => {
    console.error('----------------------- error -----------------------');
    console.error(e);
    console.error('-----------------------------------------------------');
